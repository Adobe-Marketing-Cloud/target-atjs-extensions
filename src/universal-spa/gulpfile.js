...
gulp.task('build:dist', () => {
  return gulp.src([
      'src/header.js',
      'src/adobe.target.ext.universal.receiver.js',
      'src/adobe.target.ext.universal.router.polyfill.weakmap+mutationobserver.js',
      'src/adobe.target.ext.universal.router.js'
    ])
    .pipe(plumber())
    .pipe(concat('universal-spa-' + version + '.js'))
